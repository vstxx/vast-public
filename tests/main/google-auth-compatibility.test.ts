...
test('auth-sensitive requests bypass blockers and identity rewriting only in auth scope', () => {
  ...
  assert.match(sessionsSource, /!bypassAdBlocking && settings\.privacy\.adBlockerEnabled/)
  assert.match(sessionsSource, /hostMatchesList\(openerUrl, settings\.privacy\.adBlockAllowlist\)/)
