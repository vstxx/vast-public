/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=public/wrangler.jsonc --env=staging --env-interface=PublicEnv` (hash: 6033d9648ff5b0954e51ade7f1e122f2)
// Runtime types generated with workerd@1.20260811.1 2026-08-10 nodejs_compat
interface __BaseEnv_PublicEnv {
	ASSETS: R2Bucket;
	DB: D1Database;
	CHECKIN_SOURCE_RATE_LIMIT: RateLimit;
	CHECKIN_INSTALL_RATE_LIMIT: RateLimit;
	ASSET_SOURCE_RATE_LIMIT: RateLimit;
	ENVIRONMENT: "staging";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/public/index");
	}
