/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=extensions-hub/wrangler.jsonc extensions-hub/worker-configuration.d.ts` (hash: 6aa421a17f737a1d8ec1d5fddf4a562f)
...
interface __BaseEnv_Env {
	...
	HUB_ORIGIN: "https://extensions-staging.vastbrowser.com" | "https://extensions.vastbrowser.com";
	GITHUB_REDIRECT_URI: "https://extensions-staging.vastbrowser.com/auth/github/callback" | "https://extensions.vastbrowser.com/auth/github/callback";
	SIGNING_KEY_ID: "vast-hub-staging-2026-02" | "vast-hub-2026-02";
	HUB_LEGAL_OPERATOR_NAME: "Jan Nowacki";
	HUB_LEGAL_CONTACT_URL: "https://vastbrowser.com/legal";
	HUB_SIGNER: Fetcher /* vast-extensions-hub-signer-staging */ | Fetcher /* vast-extensions-hub-signer */;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		ASSETS: Fetcher;
		ENVIRONMENT: "staging";
		HUB_ORIGIN: "https://extensions-staging.vastbrowser.com";
		GITHUB_REDIRECT_URI: "https://extensions-staging.vastbrowser.com/auth/github/callback";
		SIGNING_KEY_ID: "vast-hub-staging-2026-02";
		HUB_LEGAL_OPERATOR_NAME: "Jan Nowacki";
		HUB_LEGAL_CONTACT_URL: "https://vastbrowser.com/legal";
		HUB_SIGNER: Fetcher /* vast-extensions-hub-signer-staging */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "HUB_ORIGIN" | "GITHUB_REDIRECT_URI" | "SIGNING_KEY_ID" | "HUB_LEGAL_OPERATOR_NAME" | "HUB_LEGAL_CONTACT_URL">> {}
}
